...
#       should choose Rock (X). This ends in a loss for you with a score of 1 (1
#       + 0).
...
with open('input.txt') as fd:
    for line in fd:
        plays = line.split()
        result = key[player1[plays[0]]][player2[plays[1]]]
        running_total += shape_point[plays[1]]
        running_total += result_point[result]
